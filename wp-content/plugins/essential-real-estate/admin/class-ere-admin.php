...
if (!class_exists('ERE_Admin')) {
    ...
    class ERE_Admin
    {
                                ...
                                array(
                                    ...
                                    'fields' => array(
                                        ...
                                        array(
                                            ...
                                            'fields' => array(
                                                array(
                                                    ...
                                                    'title' => esc_html__('Commercial Offices:', 'essential-real-estate'),
                                                    'type' => 'select',
                                                    'options' => $this->get_all_taxonomies(
                                                        array(
                                                            'taxonomy' => 'property-commer-offices', 
                                                            'hide_empty' => 0,
                                                            'meta_key'=>'property_commer_offices_order_number',
                                                            'orderby'=>'meta_value_num',
                                                            'order' => 'ASC'
                                                        )
                                                    ),
                                                ...
                                                array(
                                                    ...
                                                    'options' => $this->get_all_taxonomies(
                                                        array(
                                                            ...
                                                            'hide_empty' => 0,
                                                            'meta_key'=>'property_commer_retail_order_number',
                                                            'orderby'=>'meta_value_num',
                                                            'order' => 'ASC'
                                                        )
                                                    ),
                                                ...
                                                array(
                                                    ...
                                                    'options' => $this->get_all_taxonomies(
                                                        array(
                                                            ...
                                                            'hide_empty' => 0,
                                                            'meta_key'=>'property_commer_industrial_order_number',
                                                            'orderby'=>'meta_value_num',
                                                            'order' => 'ASC'
                                                        )
                                                    ),
                                        ...
                                        array(
                                            ...
                                            'fields' => array(
                                                array(
                                                    ...
                                                    'title' => esc_html__('Land/Development:', 'essential-real-estate'),
                                                    'type' => 'select',
                                                    'options' => $this->get_all_taxonomies(
                                                        array(
                                                            'taxonomy' => 'property-commer-land', 
                                                            'hide_empty' => 0,
                                                            'meta_key'=>'property_commer_land_order_number',
                                                            'orderby'=>'meta_value_num',
                                                            'order' => 'ASC'
                                                        )
                                                    ),
                                                ...
                                                array(
                                                    ...
                                                    'options' => $this->get_all_taxonomies(
                                                        array(
                                                            ...
                                                            'hide_empty' => 0,
                                                            'meta_key'=>'property_commer_other_order_number',
                                                            'orderby'=>'meta_value_num',
                                                            'order' => 'ASC'
                                                        )
                                                    ),
                                        ...
                                        array(
                                            ...
                                            'fields' => array(
                                                array(
                                                    'id' => "{$meta_prefix}property_resid_rent_type",
                                                    'title' => esc_html__('Rent Type:', 'essential-real-estate'),
                                                    'type' => 'select',
                                                    'options' => $this->get_all_taxonomies(
                                                        array(
                                                            'taxonomy' => 'property-resid-rent-type', 
                                                            'hide_empty' => 0,
                                                            'meta_key'=>'property_resid_rent_type_order_number',
                                                            'orderby'=>'meta_value_num',
                                                            'order' => 'ASC'
                                                        )
                                                    ),
                                                ...
                                                array(
                                                    ...
                                                    'options' => $this->get_all_taxonomies(
                                                        array(
                                                            'taxonomy' => 'property-commer-rent-type', 
                                                            'hide_empty' => 0,
                                                            'meta_key'=>'property_commer_rent_type_order_number',
                                                            'orderby'=>'meta_value_num',
                                                            'order' => 'ASC'
                                                        )
                                                    ),
                                        ...
                                        array(
                                            ...
                                            'fields' => array(
                                                ...
                                                /*array(
                                                    ...
                                                    'options' => $this->get_all_taxonomies(
                                                        array(
                                                            'taxonomy' => 'property-london-postcodes', 
                                                            'hide_empty' => 0,
                                                            'meta_key'=>'property_london_postcodes_order_number',
                                                            'orderby'=>'meta_value_num',
                                                            'order' => 'ASC'
                                                        )
                                                    ),
        ...
        public function register_taxonomy($taxonomies)
        {
            ...
            $taxonomies['property-resid-rent-type'] = apply_filters('ere_register_taxonomy_property_resid_rent_type', array(
                'post_type' => 'property',
                'hierarchical' => false,
                'meta_box_cb' => array($this, 'taxonomy_select_meta_box'),
                'label' => esc_html__('Resid. Rent Type', 'essential-real-estate'),
                'show_in_quick_edit' => false,
                'singular_name' => esc_html__('Resid. Rent Type', 'essential-real-estate'),
                'rewrite' => array(
            ...
            $taxonomies['property-commer-offices'] = apply_filters('ere_register_taxonomy_property_commer_offices', array(
                ...
                'hierarchical' => false,
                'meta_box_cb' => array($this, 'taxonomy_select_meta_box'),
                'label' => esc_html__('Commer. Offices', 'essential-real-estate'),
                'show_in_quick_edit' => false,
                'singular_name' => esc_html__('Commercial Offices', 'essential-real-estate'),
                'rewrite' => array(
                    'slug' => apply_filters('ere_property_commer_offices_slug', 'property-commer-offices'),
                ),
            ));
            $taxonomies['property-commer-retail'] = apply_filters('ere_register_taxonomy_property_commer_retail', array(
                'post_type' => 'property',
                'hierarchical' => false,
                'meta_box_cb' => array($this, 'taxonomy_select_meta_box'),
                'label' => esc_html__('Commer. Retail', 'essential-real-estate'),
                'show_in_quick_edit' => false,
                'singular_name' => esc_html__('Commercial Retail', 'essential-real-estate'),
                'rewrite' => array(
            ...
            $taxonomies['property-commer-leisure'] = apply_filters('ere_register_taxonomy_property_commer_leisure', array(
                ...
                'show_in_quick_edit' => false,
                'singular_name' => esc_html__('Commercial Leisure/Hospitality', 'essential-real-estate'),
                'rewrite' => array(
                    'slug' => apply_filters('ere_property_commer_leisure_slug', 'property-commer-leisure'),
                ),
            ));
            $taxonomies['property-commer-industrial'] = apply_filters('ere_register_taxonomy_property_commer_industrial', array(
                'post_type' => 'property',
                'hierarchical' => false,
                'meta_box_cb' => array($this, 'taxonomy_select_meta_box'),
                'label' => esc_html__('Commer. Industrial/Warehousing', 'essential-real-estate'),
                'show_in_quick_edit' => false,
                'singular_name' => esc_html__('Commercial Industrial/Warehousing', 'essential-real-estate'),
                'rewrite' => array(
                    'slug' => apply_filters('ere_property_commer_industrial_slug', 'property-commer-industrial'),
                ),
            ));
            $taxonomies['property-commer-land'] = apply_filters('ere_register_taxonomy_property_commer_land', array(
                'post_type' => 'property',
                'hierarchical' => false,
                'meta_box_cb' => array($this, 'taxonomy_select_meta_box'),
                'label' => esc_html__('Commer. Land/Development', 'essential-real-estate'),
                'show_in_quick_edit' => false,
                'singular_name' => esc_html__('Commercial Land/Development', 'essential-real-estate'),
                'rewrite' => array(
                    'slug' => apply_filters('ere_property_commer_land_slug', 'property-commer-land'),
                ),
            ));
            $taxonomies['property-commer-other'] = apply_filters('ere_register_taxonomy_property_commer_other', array(
                'post_type' => 'property',
                'hierarchical' => false,
                'meta_box_cb' => array($this, 'taxonomy_select_meta_box'),
                'label' => esc_html__('Commer. Other', 'essential-real-estate'),
                'show_in_quick_edit' => false,
                'singular_name' => esc_html__('Commercial Other', 'essential-real-estate'),
                'rewrite' => array(
                    'slug' => apply_filters('ere_property_commer_other_slug', 'property-commer-other'),
                ),
            ));
            $taxonomies['property-commer-rent-type'] = apply_filters('ere_register_taxonomy_property_commer_rent_type', array(
                'post_type' => 'property',
                'hierarchical' => false,
                'meta_box_cb' => array($this, 'taxonomy_select_meta_box'),
                'label' => esc_html__('Commer. Rent Type', 'essential-real-estate'),
                'show_in_quick_edit' => false,
                'singular_name' => esc_html__('Commer. Rent Type', 'essential-real-estate'),
                'rewrite' => array(
                    'slug' => apply_filters('ere_property_commer_rent_type_slug', 'property-commer-rent-type'),
                ),
            ));
            ...
            /*$taxonomies['property-london-postcodes'] = apply_filters('ere_register_taxonomy_property_london_postcodes', array(
                ...
                'hierarchical' => false,
                'meta_box_cb' => array($this, 'taxonomy_select_meta_box'),
                'label' => esc_html__('London Postcodes', 'essential-real-estate'),
                'show_in_quick_edit' => false,
                'singular_name' => esc_html__('London Postcodes', 'essential-real-estate'),
                'rewrite' => array(
        ...
        public function register_term_meta($configs)
        {
            ...
            $configs['property-resid-rent-type-settings'] = apply_filters('ere_register_term_meta_property_resid_rent_type', array(
                'name' => esc_html__('Taxonomy Setting', 'essential-real-estate'),
                'layout' => 'horizontal',
                'taxonomy' => array('property-resid-rent-type'),
                'fields' => array(
                    array(
                        'id' => 'property_resid_rent_type_icon',
                        'title' => esc_html__('Icon image', 'essential-real-estate'),
                        'desc' => esc_html__('Icon display on map', 'essential-real-estate'),
                        'type' => 'image',
                        'default' => '',
                    ...
                    array(
                        'title' => __('Order Number', 'essential-real-estate'),
                        'subtitle' => esc_html__('The number to set orderby', 'essential-real-estate'),
                        'id' => "property_resid_rent_type_order_number",
                        'type' => 'text',
                        'default' => '1',
                        'pattern' => '[0-9]*'
                    ),
            ...
            $configs['property-commer-offices-settings'] = apply_filters('ere_register_term_meta_property_commer_offices', array(
                'name' => esc_html__('Taxonomy Setting', 'essential-real-estate'),
                'layout' => 'horizontal',
                'taxonomy' => array('property-commer-offices'),
                'fields' => array(
                    array(
                        'id' => 'property_commer_offices_icon',
                        'title' => esc_html__('Icon image', 'essential-real-estate'),
                        'desc' => esc_html__('Icon display on map', 'essential-real-estate'),
                        'type' => 'image',
                        'default' => '',
                    ...
                    array(
                        'title' => __('Order Number', 'essential-real-estate'),
                        'subtitle' => esc_html__('The number to set orderby', 'essential-real-estate'),
                        'id' => "property_commer_offices_order_number",
                        'type' => 'text',
                        'default' => '1',
                        'pattern' => '[0-9]*'
                    ),
            ...
            $configs['property-commer-retail-settings'] = apply_filters('ere_register_term_meta_property_commer_retail', array(
                'name' => esc_html__('Taxonomy Setting', 'essential-real-estate'),
                'layout' => 'horizontal',
                'taxonomy' => array('property-commer-retail'),
                'fields' => array(
                    array(
                        'id' => 'property_commer_retail_icon',
                        'title' => esc_html__('Icon image', 'essential-real-estate'),
                        'desc' => esc_html__('Icon display on map', 'essential-real-estate'),
                        'type' => 'image',
                        'default' => '',
            ...
            $configs['property-commer-industrial-settings'] = apply_filters('ere_register_term_meta_property_commer_industrial', array(
                'name' => esc_html__('Taxonomy Setting', 'essential-real-estate'),
                'layout' => 'horizontal',
                'taxonomy' => array('property-commer-industrial'),
                'fields' => array(
                    array(
                        'id' => 'property_commer_industrial_icon',
                        'title' => esc_html__('Icon image', 'essential-real-estate'),
                        'desc' => esc_html__('Icon display on map', 'essential-real-estate'),
                        'type' => 'image',
                        'default' => '',
                    ...
                    array(
                        'title' => __('Order Number', 'essential-real-estate'),
                        'subtitle' => esc_html__('The number to set orderby', 'essential-real-estate'),
                        'id' => "property_commer_industrial_order_number",
                        'type' => 'text',
                        'default' => '1',
                        'pattern' => '[0-9]*'
                    ),
            ...
            $configs['property-commer-land-settings'] = apply_filters('ere_register_term_meta_property_commer_land', array(
                'name' => esc_html__('Taxonomy Setting', 'essential-real-estate'),
                'layout' => 'horizontal',
                'taxonomy' => array('property-commer-land'),
                'fields' => array(
                    array(
                        'id' => 'property_commer_land_icon',
                        'title' => esc_html__('Icon image', 'essential-real-estate'),
                        'desc' => esc_html__('Icon display on map', 'essential-real-estate'),
                        'type' => 'image',
                        'default' => '',
                    ...
                    array(
                        'title' => __('Order Number', 'essential-real-estate'),
                        'subtitle' => esc_html__('The number to set orderby', 'essential-real-estate'),
                        'id' => "property_commer_land_order_number",
                        'type' => 'text',
                        'default' => '1',
                        'pattern' => '[0-9]*'
                    ),
            ...
            $configs['property-commer-other-settings'] = apply_filters('ere_register_term_meta_property_commer_other', array(
                'name' => esc_html__('Taxonomy Setting', 'essential-real-estate'),
                'layout' => 'horizontal',
                'taxonomy' => array('property-commer-other'),
                'fields' => array(
                    array(
                        'id' => 'property_commer_other_icon',
                        'title' => esc_html__('Icon image', 'essential-real-estate'),
                        'desc' => esc_html__('Icon display on map', 'essential-real-estate'),
                        'type' => 'image',
                        'default' => '',
                    ...
                    array(
                        'title' => __('Order Number', 'essential-real-estate'),
                        'subtitle' => esc_html__('The number to set orderby', 'essential-real-estate'),
                        'id' => "property_commer_other_order_number",
                        'type' => 'text',
                        'default' => '1',
                        'pattern' => '[0-9]*'
                    ),
            ...
            $configs['property-commer-rent-type-settings'] = apply_filters('ere_register_term_meta_property_commer_rent_type', array(
                'name' => esc_html__('Taxonomy Setting', 'essential-real-estate'),
                'layout' => 'horizontal',
                'taxonomy' => array('property-commer-rent-type'),
                'fields' => array(
                    array(
                        'id' => 'property_commer_rent_type_icon',
                        'title' => esc_html__('Icon image', 'essential-real-estate'),
                        'desc' => esc_html__('Icon display on map', 'essential-real-estate'),
                        'type' => 'image',
                        'default' => '',
                    ...
                    array(
                        'title' => __('Order Number', 'essential-real-estate'),
                        'subtitle' => esc_html__('The number to set orderby', 'essential-real-estate'),
                        'id' => "property_commer_rent_type_order_number",
                        'type' => 'text',
                        'default' => '1',
                        'pattern' => '[0-9]*'
                    ),
            ...
            /*$configs['property-london-postcodes-settings'] = apply_filters('ere_register_term_meta_property_london_postcodes', array(
                ...
                'fields' => array(
                    array(
                        'id' => 'property_london_postcodes_icon',
                        'title' => esc_html__('Icon image', 'essential-real-estate'),
                        'desc' => esc_html__('Icon display on map', 'essential-real-estate'),
                        'type' => 'image',
                        'default' => '',
                    ...
                    array(
                        'title' => __('Order Number', 'essential-real-estate'),
                        'subtitle' => esc_html__('The number to set orderby', 'essential-real-estate'),
                        'id' => "property_london_postcodes_order_number",
                        'type' => 'text',
                        'default' => '1',
                        'pattern' => '[0-9]*'
                    ),
                ...
                'fields' => array_merge(
                    ...
                    apply_filters('ere_register_option_url_slugs_main', array(
                        ...
                        array(
                            ...
                            'title' => esc_html__('Property Commercial Rent Type Slug', 'essential-real-estate'),
                            'type' => 'text',
                            'default' => 'property-commer-rent-type',
                        ),
                        array(
                            ...
                            'fields' => array(
                                array(
                                    ...
                                    'options' => array(
                                        ...
                                        'property_resid_rent_type' => esc_html__('Residential Rent Type', 'essential-real-estate'),
            ...
            return apply_filters('ere_register_option_search', array(
                ...
                'fields' => array_merge(
                    ...
                    apply_filters('ere_register_option_search_main', array(
                        ...
                        //                 'property_residential_type', 'property_resid_furnished_type', 'property_resid_rent_type'
                        //                 'property_commer_offices', 'property_commer_retail', 'property_commer_leisure', 'property_commer_industrial', 'property_commer_land', 'property_commer_other', 'property_commer_rent_type',

...
if (!class_exists('ERE_Admin_Property')) {
    ...
    class ERE_Admin_Property
    {
        ...
        public function display_custom_column($column)
        {
            ...
            switch ($column) {
                ...
                case 'commer-retail':
                    ...
                    break;
                case 'commer-leisure':
                    echo ere_admin_taxonomy_terms($post->ID, 'property-commer-leisure', 'property');
                    break;
                case 'commer-industrial':
                    echo ere_admin_taxonomy_terms($post->ID, 'property-commer-industrial', 'property');
                    break;
                case 'commer-land':
                ...
                case 'status':
                    ...
                    break;
                case 'london-postcodes':
                    echo ere_admin_taxonomy_terms($post->ID, 'property-london-postcodes', 'property');
                    break;
                case 'price':
         ...
         * @return string
         */
        public function modify_property_residential_type_slug($existing_slug)
        {
         ...
         * @return string
         */
        public function modify_property_commer_offices_slug($existing_slug)
        {
        ...
        /**
         * Modify commercial leisure slug
         * @param $existing_slug
         * @return string
         */
        public function modify_property_commer_leisure_slug($existing_slug)
        {
            $property_commer_leisure_url_slug = ere_get_option('property_commer_leisure_url_slug');
            if ($property_commer_leisure_url_slug) {
                return $property_commer_leisure_url_slug;
            }
            return $existing_slug;
        }

        /**
         * Modify commercial industrial slug
         * @param $existing_slug
         * @return string
         */
        public function modify_property_commer_industrial_slug($existing_slug)
        {
            $property_commer_industrial_url_slug = ere_get_option('property_commer_industrial_url_slug');
            if ($property_commer_industrial_url_slug) {
                return $property_commer_industrial_url_slug;
            }
            return $existing_slug;
        }
        
        /**
         * Modify commercial land slug
         * @param $existing_slug
         * @return string
         */
        public function modify_property_commer_land_slug($existing_slug)
        {
            $property_commer_land_url_slug = ere_get_option('property_commer_land_url_slug');
            if ($property_commer_land_url_slug) {
                return $property_commer_land_url_slug;
            }
            return $existing_slug;
        }
        ...
        public function add_columns_property_london_postcodes($columns){
            ...
            $columns['description'] = esc_html__('Description', 'essential-real-estate');
            $columns['slug'] = esc_html__('Slug', 'essential-real-estate');
            $columns['property_london_postcodes_order_number'] = esc_html__('Order', 'essential-real-estate');
            $columns['posts'] = esc_html__('Count', 'essential-real-estate');
            $new_columns = array();
            $custom_order = array('cb','name','description', 'slug', 'property_london_postcodes_order_number','posts');
            foreach ($custom_order as $colname){
                $new_columns[$colname] = $columns[$colname];
            }
            return $new_columns;
        }
        public function add_columns_property_london_postcodes_content( $content, $column_name, $term_id ){
            if( $column_name !== 'property_london_postcodes_order_number' ){
                return $content;
            }
            $term_id = absint( $term_id );
            $property_london_postcodes_tax = get_term_meta( $term_id, 'property_london_postcodes_order_number', true );
            if ((!empty($property_london_postcodes_tax) && isset($property_london_postcodes_tax)) || 
                (strval($property_london_postcodes_tax) == '0'))
            {
                $content .= esc_html( $property_london_postcodes_tax );
            }
            return $content;
        }

(function ($) {
    ...
    $(document).ready(function () {
        ...
        /*var london_postcodes_box_taxonomy ='#tagsdiv-property-london-postcodes';
        var london_postcodes_box_taxonomy_select = london_postcodes_box_taxonomy + ' select[name="tax_input[property-london-postcodes][]"]';
        var london_postcodes_box_post_select  ='#real_estate_property_london_postcodes select[name="real_estate_property_london_postcodes"]';
        $(london_postcodes_box_taxonomy).css("display", "none");
        $(london_postcodes_box_taxonomy_select).val($(london_postcodes_box_post_select).val());
        $(london_postcodes_box_post_select).change(function(){
            $(london_postcodes_box_taxonomy_select).val($(this).val());
        });*/

        var country_box_taxonomy ='#real_estate_property_country';
        var country_box_taxonomy_select = country_box_taxonomy + ' select[name="ere[ere_property_country]"]';
        var country_box_post_select ='#real_estate_property_country_name select[name="real_estate_property_country_name"]';
        $(country_box_taxonomy).css("display", "none");
        $(country_box_post_select).val($(country_box_taxonomy_select).val());
        $(country_box_post_select).change(function(){
            $(country_box_taxonomy_select).val($(this).val());
        });
        
        $('#pageparentdiv').css("display", "none");

        var prop_feature_box_taxonomy ='#taxonomy-property-feature';
        var prop_feature_box_taxonomy_checkbox = prop_feature_box_taxonomy + ' input[name="tax_input[property-feature][]"]';
        var prop_feature_box_post_checkbox  ='#real_estate_property_feature select[name="real_estate_property_feature[]"]';
        $("#property-featurediv").css("display", "none");
        $(prop_feature_box_post_checkbox).change(function(){
            var checked_array_post = $(this).val();
            $(prop_feature_box_taxonomy_checkbox).each(function(){
        ...
        $(prop_group_box_post_radio).change(function(){
            ...
            if (group_val == 0 || group_val == "0") {
                ...
                $('#real_estate_property_feature .gsf-field-content-wrap').css('display', '');
                ...
                $('#real_estate_property_feature .gsf-field-content-wrap').css('display', 'none');
            }
        });
        ...
        $('#real_estate_additional_features .gsf-label').css("display", "none");
        ...
        var autocomplete = $("#real_estate_search_london_postcodes input").tablecomplete({
            delay: 0,
            ...
            select: function( event , ui ) {
                $("#real_estate_search_london_postcodes input").val(ui.item.postcode);
                $("#real_estate_property_location_zip input").val(ui.item.postcode);
                $("#real_estate_property_location_latitude input").val(ui.item.latitude);
                $("#real_estate_property_location_longitude input").val(ui.item.longitude);
            }
        });
        ...
        $("#real_estate_property_country_name select").on('change', function () {
            if (this.value.trim().toUpperCase() == "GB") {
                $("#real_estate_property_city_name input").val("London");
                $("#real_estate_search_london_postcodes").css('display', '');
                $("#real_estate_property_zip input").attr('disabled', 'disabled');
            } else {
                if ($("#real_estate_property_city_name input").val().trim().toUpperCase() == "LONDON")
                    $("#real_estate_property_city_name input").val("");
                $("#real_estate_search_london_postcodes").css('display', 'none');
                $("#real_estate_property_zip input").removeAttr('disabled');
            }
        });
        
        $("#real_estate_property_city_name input").on('change', function () {
        ...
        if ($("#real_estate_property_city_name input") != null && 
            $("#real_estate_property_city_name input").val() != null &&
            $("#real_estate_property_city_name input").val() !== undefined) 
        {
            if ($("#real_estate_property_city_name input").val().trim().toUpperCase() == "LONDON") {
                $("#real_estate_search_london_postcodes").css('display', '');
                $("#real_estate_property_zip input").attr('disabled', 'disabled');

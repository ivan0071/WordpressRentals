(function ($) {
    ...
    $(document).ready(function () {
        ...
        //----------------
        var sqFT = $('#real_estate_property_size input').val();
        var sqM = parseFloat(parseFloat(sqFT) / unitsConversionParameter);
        $('#real_estate_property_size_m2 input').val(sqM);
        $('#real_estate_property_size_m2 input').prop('disabled', true);

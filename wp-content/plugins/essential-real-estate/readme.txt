...
[Main Site](http://plugins.g5plus.net/ere/?utm_source=wp&utm_medium=ere_description&utm_content=website_introduction) | [Docs](http://document.g5plus.net/essential-real-estate/) | [Add-ons](http://plugins.g5plus.net/ere/add-ons/?utm_source=wp&utm_medium=ere_description&utm_content=ere_colors#ere_colors) | [Premium Theme](https://themeforest.net/item/beyot-wordpress-real-estate-theme/19514964?ref=g5theme&utm_source=wp&utm_medium=ere_description&utm_content=view_demo_beyot)
...
= Sample Data Demo =
* Download xml file: [sample-data.xml](http://document.g5plus.net/essential-real-estate/sample-data.xml)
* Download zip file: [sample-data.zip](http://document.g5plus.net/essential-real-estate/sample-data.zip)

== Add-ons ==
* [ERE Colors - Addons Free](http://plugins.g5plus.net/ere/add-ons/?utm_source=wp&utm_medium=ere_description&utm_content=ere_colors#ere_colors)
* [ERE Recently Viewed - Addons Free](http://plugins.g5plus.net/ere/add-ons/?utm_source=wp&utm_medium=ere_description&utm_content=ere_recently_viewed#ere_recently_viewed)
* [ERE Similar Properties - Addons Free](http://plugins.g5plus.net/ere/add-ons/?utm_source=wp&utm_medium=ere_description&utm_content=ere_similar_properties#ere_similar_properties)

= Demo with premium theme =
* [FrontEnd](http://demo.g5plus.net/?theme=beyot) (acount: demo/demo)
* [BackEnd](http://demo.g5plus.net/beyot/wp-admin) (acount: agency/agency)

> You can [View demo or buy Beyot WP theme](https://themeforest.net/item/beyot-wordpress-real-estate-theme/19514964?ref=g5theme&utm_source=wp&utm_medium=ere_description&utm_content=view_demo_beyot).
> You can [View demo or buy Fuzdo WP theme](https://themeforest.net/item/fuzdo-real-estate-wordpress-theme/21020693?ref=themevin).
> You can [View demo or buy Benaa WP theme](https://themeforest.net/item/benaa-real-estate-wordpress-theme/21413304?ref=g5theme&utm_source=wp&utm_medium=ere_description&utm_content=view_demo_benaa).

#### Video how to
[youtube https://www.youtube.com/playlist?list=PL_DzVbdOfv7EJSkMOf84gpYGzZqvrwv4H&utm_source=wp&utm_medium=ere_description&utm_content=video_howto]

= Features =

* Already define pages for Real Estate website like: Search Page, Listing Properties, Listing Agent, Agency, Payment, Profile,...
...
1. Go to menu Essential Real Estate -> Real Estate Options screen to configure the plugin
...
8. Payment method already supported
9. My profile of user on frontend management

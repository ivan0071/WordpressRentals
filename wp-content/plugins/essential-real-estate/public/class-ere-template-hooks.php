...
if (!class_exists('ERE_Template_Hooks')) {
    ...
    class ERE_Template_Hooks
    {
        ...
        public function __construct()
        {
            ...
            $this->loader->add_action('ere_loop_property_map', $this, 'loop_property_map', null, [], 10, 2);
            //Advanced Search
         ...
         */
        public function home_property_search()
        {
         ...
         * @param $custom_property_image_size
         */
        public function loop_property_map($dataMap, $latLongData, $property_item_class, $custom_property_image_size)
        {
            ere_get_template('loop/property-map.php', array('dataMap' => $dataMap, 'latLongData' => $latLongData, 'property_item_class' => $property_item_class, 'custom_property_image_size' => $custom_property_image_size));
        }

...
wp_enqueue_script(ERE_PLUGIN_PREFIX . 'home-big-slider', ERE_PLUGIN_URL . 'public/templates/shortcodes/home-big-slider/assets/js/home-big-slider' . $min_suffix_js . '.js', array('jquery', ERE_PLUGIN_PREFIX . 'owl_carousel'), ERE_PLUGIN_VER, true);
?>
<div class="<?php echo join(' ', $wrapper_classes) ?>" <?php echo implode(' ', $wrapper_attributes); ?>>
    ...
    <?php else: ?>
        <?php ere_get_template('shortcodes/home-big-slider/templates/' . $layout_style . '.php',
            array(

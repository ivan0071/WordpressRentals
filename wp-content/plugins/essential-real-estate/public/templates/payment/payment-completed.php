...
<div class="ere-payment-completed-wrap">
    ...
    if (isset($_GET['order_id']) && $_GET['order_id'] != ''):
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12">
                ...
                <div class="ere-thankyou-content"><?php echo ere_get_option('thankyou_content_wire_transfer',''); ?></div>
    ...
    <?php else: ?>
        ...
        <div class="ere-thankyou-content"><?php echo ere_get_option('thankyou_content',''); ?></div>
        <a href="<?php echo ere_get_permalink('my_properties'); ?>"
           class="btn btn-primary"> <?php esc_html_e('Go to Dashboard', 'essential-real-estate'); ?> </a>
    <?php endif;

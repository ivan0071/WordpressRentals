    ...
    $(document).ready(function () {
        if (typeof ere_property_vars !== "undefined") {
            ...
            var ere_execute_group = function () {
                var $this = $('[name="property_group_Residential0_Commercial1"][checked]', '.property-group-control'),
                    group_val = $this.val(),
                ...
                $('input[name="property_group_Residential0_Commercial1"]', '.property-group-control').each(function () {
                ...
                // $('input[name="property_group_Residential0_Commercial1"]', '.property-group-control').on('change', function () {
                //     ere_execute_group();
                // });
            };
            ere_execute_group();

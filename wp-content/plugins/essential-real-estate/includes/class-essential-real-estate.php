...
if (!class_exists('Essential_Real_Estate')) {
    ...
    class Essential_Real_Estate
    {
        ...
        private function admin_hooks()
        {
            ...
            $this->loader->add_filter('manage_edit-property-residential-type_columns', $admin_property,  'add_columns_property_residential_type');
            $this->loader->add_filter('manage_property-residential-type_custom_column', $admin_property,  'add_columns_property_residential_type_content', 10, 3 );
            $this->loader->add_filter('manage_edit-property-residential-type_sortable_columns',  $admin_property,  'add_columns_property_residential_type_sortable' );
            $this->loader->add_filter('manage_edit-property-resid-furnished-type_columns', $admin_property,  'add_columns_property_resid_furnished_type');
            $this->loader->add_filter('manage_property-resid-furnished-type_custom_column', $admin_property,  'add_columns_property_resid_furnished_type_content', 10, 3 );
            $this->loader->add_filter('manage_edit-property-resid-furnished-type_sortable_columns',  $admin_property,  'add_columns_property_resid_furnished_type_sortable' );
            $this->loader->add_filter('manage_edit-property-resid-rent-type_columns', $admin_property,  'add_columns_property_resid_rent_type');
            $this->loader->add_filter('manage_property-resid-rent-type_custom_column', $admin_property,  'add_columns_property_resid_rent_type_content', 10, 3 );
            $this->loader->add_filter('manage_edit-property-resid-rent-type_sortable_columns',  $admin_property,  'add_columns_property_resid_rent_type_sortable' );
            $this->loader->add_filter('manage_edit-property-commer-offices_columns', $admin_property,  'add_columns_property_commer_offices');
            $this->loader->add_filter('manage_property-commer-offices_custom_column', $admin_property,  'add_columns_property_commer_offices_content', 10, 3 );
            $this->loader->add_filter('manage_edit-property-commer-offices_sortable_columns',  $admin_property,  'add_columns_property_commer_offices_sortable' );
            $this->loader->add_filter('manage_edit-property-commer-retail_columns', $admin_property,  'add_columns_property_commer_retail');
            $this->loader->add_filter('manage_property-commer-retail_custom_column', $admin_property,  'add_columns_property_commer_retail_content', 10, 3 );
            $this->loader->add_filter('manage_edit-property-commer-retail_sortable_columns',  $admin_property,  'add_columns_property_commer_retail_sortable' );
            $this->loader->add_filter('manage_edit-property-commer-leisure_columns', $admin_property,  'add_columns_property_commer_leisure');
            $this->loader->add_filter('manage_property-commer-leisure_custom_column', $admin_property,  'add_columns_property_commer_leisure_content', 10, 3 );
            $this->loader->add_filter('manage_edit-property-commer-leisure_sortable_columns',  $admin_property,  'add_columns_property_commer_leisure_sortable' );
            $this->loader->add_filter('manage_edit-property-commer-industrial_columns', $admin_property,  'add_columns_property_commer_industrial');
            $this->loader->add_filter('manage_property-commer-industrial_custom_column', $admin_property,  'add_columns_property_commer_industrial_content', 10, 3 );
            $this->loader->add_filter('manage_edit-property-commer-industrial_sortable_columns',  $admin_property,  'add_columns_property_commer_industrial_sortable' );
            $this->loader->add_filter('manage_edit-property-commer-land_columns', $admin_property,  'add_columns_property_commer_land');
            $this->loader->add_filter('manage_property-commer-land_custom_column', $admin_property,  'add_columns_property_commer_land_content', 10, 3 );
            $this->loader->add_filter('manage_edit-property-commer-land_sortable_columns',  $admin_property,  'add_columns_property_commer_land_sortable' );
            $this->loader->add_filter('manage_edit-property-commer-other_columns', $admin_property,  'add_columns_property_commer_other');
            $this->loader->add_filter('manage_property-commer-other_custom_column', $admin_property,  'add_columns_property_commer_other_content', 10, 3 );
            $this->loader->add_filter('manage_edit-property-commer-other_sortable_columns',  $admin_property,  'add_columns_property_commer_other_sortable' );
            ...
            $this->loader->add_filter('ere_property_resid_rent_type_slug', $admin_property, 'modify_property_resid_rent_type_slug');

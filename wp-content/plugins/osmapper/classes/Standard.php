...
//	                debug($_SERVER);
	                ...
	                echo '<a target="_blank" href="https://b4after.pl/osmapper/en?utm_source='.$url.'&utm_medium=admin_panel&utm_campaign=OSMapper">
					<img style="max-width:100%; height: auto;" src="'.BAMAP_URL.'assets/images/pro-banner.png">
					</a>'; ?>
                </p>
            </div>
            <?php
